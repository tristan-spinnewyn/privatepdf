        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
            ...
            <div>
              <div className="flex items-center space-x-2">
                <span className="font-extrabold text-lg tracking-tight text-slate-900">
                  PDF<span className="text-rose-600">Privé</span>
                </span>
              ...
              <p className="text-[11px] text-slate-500 leading-tight hidden sm:block">
                Boîte à outils PDF sans upload serveur
              </p>
            </div>
          </div>

          {/* Privacy Badge / Explainer Button */}
          <div className="flex items-center space-x-2 sm:space-x-3">
            ...
            >
              ...
              <span className="hidden md:inline">100% Hors-ligne & Sécurisé</span>
              <span className="md:hidden">100% Privé</span>
